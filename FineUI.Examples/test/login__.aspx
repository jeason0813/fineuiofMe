<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login__.aspx.cs" Inherits="FineUI.Examples.basic.login__" %>
    ...
    <x:Window ID="Window1" runat="server" Title="登录表单" IsModal="false" EnableClose="false"
        ...
        <Toolbars>
            <x:Toolbar ID="Toolbar1" runat="server" Position="Footer">
                <Items>
                    <x:Button ID="btnLogin" Text="登录" Type="Button" ValidateForms="SimpleForm1" ValidateTarget="Top"
